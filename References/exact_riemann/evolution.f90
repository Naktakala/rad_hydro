...
! common formats
10    format('output_',i3.3,'.dat')
11    format (2x, 'i', 10x, 'x', 12x, 'density', 8x, 'pressure', 8x, 'velocity'/)
12    format (i4, 12(2x, 1pe10.2))
...
!        const1 = gamma/(gamma-1.0d0)
        ...
        write (1,12) i, x(i), rho(i), p(i), u(i),energy, temper, cv, const1, const2, entropy
