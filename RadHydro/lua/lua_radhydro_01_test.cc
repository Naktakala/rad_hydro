...
//}
  ...
  int chiRadHydroTestMFEM(lua_State* L)
  {
    ...
    chi_math::GaussElimination(Atemp,x,8);
    ...
    std::cout << "\n";
    auto x2 = chi_math::BandedSolver(A, b, 2, 2);
